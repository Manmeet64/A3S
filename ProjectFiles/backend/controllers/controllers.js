...
export const issueToken = async (req, res) => {
    try {
        ...
        // // If this is an OIDC flow, make sure the audience is passed correctly
        // if (reqData.sourceType === "OIDC" && reqData.inputOIDC) {
        //     // Keep any existing OIDC configuration
        //     console.log("📣 OIDC authentication flow detected");
        // }
